...
class Login
{
    ...
    private function loginWithPostData()
    {
        ...
        if (!empty($_POST['user_name']) && !empty($_POST['user_password'])) {
            ...
            // create a database connection, using the constants from config/db.php (which we loaded in ga.php)
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                $checklogin = $this->db_connection->query("SELECT user_name, user_email, user_password_hash, school_name, school_code FROM users WHERE user_name = '" . $this->user_name . "';");
                ...
                if ($checklogin->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
						...
						$_SESSION['school_name'] = $result_row->school_name;
						$_SESSION['school_code'] = $result_row->school_code;
